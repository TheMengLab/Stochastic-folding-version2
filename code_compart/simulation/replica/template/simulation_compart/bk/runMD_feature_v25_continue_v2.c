...
double **coor,**velvector,**velvector2,**forcelist,radius,kT,bondlen,kb,beadradius,Fmax,dt,dtp,t,sphereradius,chrgyr,pointmass,sigma,epsi,distcutoff,factor,gyr_target;
...
// printf("check dist %d %d %d %lf\n",i,367,370,getdistsq(coor[367],coor[370],DIM));
  ...
  Fmax=getforce_feature_all_noneighbor_pair_soft_sepattrep_darkatt_allpair_chr_v3(coor,pointnum,bondlen,kb,beadradius*2,sigma,epsi,targetlist,featurenum,targetlen,forcelist,sphereradius,pairlist,pairlen,allpairlist,allpairlen,chrassign);
  }

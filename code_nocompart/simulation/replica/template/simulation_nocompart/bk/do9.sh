...
#pointnum=`nl ../../../assignment/multi_chr/allgenome/assign_${id1}kb.dat | tail -n 1 | awk '{print $1}'`
...
#echo -e conf${id1}.dat '\n' ../../../assignment/multi_chr/allgenome/assign_${id1}kb.dat '\n' ../../../assignment/multi_chr/allgenome/compartassign_${id1}kb.dat '\n' ../../../assignment/multi_chr/allgenome/assign_${id2}kb.dat '\n' ../../../assignment/multi_chr/allgenome/compartassign_${id2}kb.dat '\n' initconf${id2}.dat | ./insert_contract_assign_seg.o 
...
#awk '{print 1}' ../../../assignment/multi_chr/allgenome/assign_${id2}kb.dat > sudoassign.dat

...
double **coor,**velvector,**velvector2,**forcelist,radius,kT,bondlen,kb,beadradius,Fmax,dt,dtp,t,sphereradius,chrgyr,pointmass,sigma,epsi,distcutoff,factor,gyr_target,*density,densitybase,center[DIM],maxdist;
...
sphereradius = beadradius*pow(pointnum,0.3333)*2;

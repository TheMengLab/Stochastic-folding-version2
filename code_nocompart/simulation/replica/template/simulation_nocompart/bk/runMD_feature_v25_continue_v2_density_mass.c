...
void main()
{
char inputfilename[N],assignfilename[N],outputfilename[N],densityfilename[N],massfilename[N];
int i,j,k,l,m,n,pointnum,featurenum,*assign,**featureassign,stepnum,interval,seed,assignmax,**targetlist,*targetlen,**pairlist,*pairlen,pairinterval,shrinkmax,shrinkinterval,shrinkendbool,**randompairlist,*randompairlen,sepprob,**contacttime,**allpairlist,*allpairlen,*chrassign,tempmax,maxlen,*tempassign,nextstepnum,outputnum;
...
FILE *inputfile,*assignfile,*outputfile,*densityfile,*massfile;

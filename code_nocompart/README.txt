...
The input data for the codes contains two parts: (1)the populated DNA accessibility data(we use ATAC-seq of K562 as a demonstration here, deposited as ./prepare/data_raw/ATAC_data.dat) and (2) the sequence length of each chromosome in the reference genome (we use hg19 genome, deposited as ./prepare/data_raw/hg19.chrom.sizes)
